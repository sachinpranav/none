...
class PostFeaturedImage extends \EssentialElements\Image
{
     ...
     * @return string
     */
    static function ssr($propertiesData, $parentPropertiesData = [], $isBuilder = false)
    {
        ob_start();
        ...
        $fallbackImage = @$propertiesData['content']['content']['fallback_image'];
        ...
        $p = renderDynamicDataInProps(
            array_merge_recursive(
                ...
                [
                    'content' => [
                        'content' => [
                            'image' => $featuredImage ? $featuredImage : $fallbackImage
                        ]
                    ]
                ]
            ),
