...
class MenuBuilder extends \Breakdance\Elements\Element
{
    ...
    static function designControls()
    {
        ...
        "Effect Type",
        [],
        ['type' => 'dropdown', 'layout' => 'inline', 'items' => ['0' => ['text' => 'Underline', 'value' => 'underline'], '1' => ['text' => 'Overline', 'value' => 'overline'], '2' => ['text' => 'Background', 'value' => 'background']]],
        false,
        false,
        [],
      ), c(
