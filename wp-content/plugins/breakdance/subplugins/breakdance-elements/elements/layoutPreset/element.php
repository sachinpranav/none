...
class Layoutpreset extends \Breakdance\Elements\Element
{
    ...
    static function designControls()
    {
        ...
        "Align Self",
        [],
        ['type' => 'dropdown', 'layout' => 'inline', 'items' => ['0' => ['text' => 'auto', 'label' => 'Label', 'value' => 'auto'], '1' => ['text' => 'left', 'label' => 'Label', 'value' => 'left'], '2' => ['text' => 'center', 'label' => 'Label', 'value' => 'center'], '3' => ['text' => 'right', 'label' => 'Label', 'value' => 'right'], '4' => ['text' => 'stretch', 'label' => 'Label', 'value' => 'stretch'], '5' => ['text' => 'baseline', 'label' => 'Label', 'value' => 'baseline']]],
        true,
        false,
        [],
      ), c(
