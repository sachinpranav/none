...
class Wooshoppage extends \Breakdance\Elements\Element
{
    ...
    static function designControls()
    {
      ...
      "pagination",
       ['type' => 'popout']
        ...
        "Above Products",
        [],
        ['type' => 'unit', 'layout' => 'inline', 'rangeOptions' => ['min' => 1, 'max' => 200]],
        true,
        false,
        [],
      ), c(
    ...
    {
        return ['design.products_list.elements.image.include', 'design.products_list.elements.title.include', 'design.products_list.elements.price.include', 'design.products_list.elements.rating.include', 'design.products_list.elements.sale_badge.include', 'design.products_list.elements.excerpt.include', 'design.products_list.elements.categories.include', 'design.products_list.elements.button.include', 'design.products_list.elements.quantity_input.include'];
    }
}
