...
<path d="M31 12h-11v-11c0-0.552-0.448-1-1-1h-6c-0.552 0-1 0.448-1 1v11h-11c-0.552 0-1 0.448-1 1v6c0 0.552 0.448 1 1 1h11v11c0 0.552 0.448 1 1 1h6c0.552 0 1-0.448 1-1v-11h11c0.552 0 1-0.448 1-1v-6c0-0.552-0.448-1-1-1z"/>
    ...
    {
        return ['0' =>  ['inlineScripts' => ['new BreakdanceFaq(\'%%SELECTOR%%\', { accordion: {{ content.settings.accordion ? \'true\' : \'false\' }}, openFirst: {{ content.settings.first_tab_opened ? \'true\' : \'false\' }}  });'],'scripts' => ['%%BREAKDANCE_ELEMENTS_PLUGIN_URL%%elements/Frequently_Asked_Questions/assets/faq.js'],],];
    }
...
'onMountedElement' => [['script' => '(function() {
  ...
  window.breakdanceFaqInstances[%%ID%%] = new BreakdanceFaq(\'%%SELECTOR%%\', { accordion: {{ content.settings.accordion ? \'true\' : \'false\' }}, openFirst: {{ content.settings.first_tab_opened ? \'true\' : \'false\' }}  });
}());',
],],
