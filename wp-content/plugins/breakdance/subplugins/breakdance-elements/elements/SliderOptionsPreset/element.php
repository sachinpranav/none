...
class Slideroptionspreset extends \Breakdance\Elements\Element
{
    ...
    static function designControls()
    {
        ...
        "Slides Per View",
        [],
        ['type' => 'number', 'layout' => 'inline', 'condition' => ['path' => '%%CURRENTPATH%%.effect', 'operand' => 'is none of', 'value' => ['0' => 'flip', '1' => 'fade']]],
        false,
        false,
        [],
      ), c(
        ...
        "One Per View At",
        [],
        ['type' => 'breakpoint_dropdown', 'layout' => 'vertical', 'condition' => ['path' => '%%CURRENTPATH%%.slides_per_view', 'operand' => 'is set', 'value' => '']],
        false,
        false,
        [],
      )],
        ...
        "Overlay",
        [],
        ['type' => 'toggle', 'layout' => 'inline', 'items' => ['0' => ['value' => 'inside', 'text' => 'Inside'], '1' => ['text' => 'Outside', 'value' => 'outside']], 'condition' => ['path' => '%%CURRENTPATH%%.disable', 'operand' => 'is not set', 'value' => '']],
        false,
        false,
        [],
      ), c(
      ...
      "fraction",
       ['type' => 'popout']
        ...
        "Overlay",
        [],
        ['type' => 'toggle', 'layout' => 'inline', 'items' => ['0' => ['value' => 'inside', 'text' => 'Inside'], '1' => ['text' => 'Outside', 'value' => 'outside']], 'condition' => ['path' => '%%CURRENTPATH%%.type', 'operand' => 'is none of', 'value' => ['0' => 'none']]],
        false,
        false,
        [],
      ), c(
