...
class Fancybackgroundpreset extends \Breakdance\Elements\Element
{
    ...
    static function designControls()
    {
        ...
        "Offset Y",
        [],
        ['type' => 'unit', 'layout' => 'inline', 'unitOptions' => ['types' => ['0' => '%'], 'defaultType' => '%'], 'rangeOptions' => ['min' => 0, 'max' => 200]],
        false,
        false,
        [],
      ), c(
    ...
    {
        return ['design.background.image_settings.unset_image_at', 'design.background.overlay.image_settings.unset_image_at'];
    }
