...
$sametaxo = (bool) ($propertiesData['content']['content']['same_taxonomy_term_todo_'] ?? false); // same taxonomy toggle
...
$prev_post = get_previous_post($sametaxo);
$next_post = get_next_post($sametaxo);
...
if ( $prev_post instanceof WP_Post && ($display !== "next") ) { ?>
...
if ( $next_post instanceof WP_Post && ($display !== "previous") ) { ?>
