...
class TwitterButton extends \Breakdance\Elements\Element
{
    ...
    {
        return ['0' =>  ['scripts' => ['%%BREAKDANCE_ELEMENTS_PLUGIN_URL%%dependencies-files/elements-reusable-code/twitter-elements.js'],],'1' =>  ['inlineScripts' => ['document.addEventListener("DOMContentLoaded", function(){ new BreakdanceTwitter(\'%%SELECTOR%%\'); });'],'builderCondition' => 'return false;','frontendCondition' => 'return true;',],];
    }

    static function settings()
    {
        return ['bypassPointerEvents' => true, 'withDependenciesInHtml' => false, 'dependsOnGlobalScripts' => true];
    }
