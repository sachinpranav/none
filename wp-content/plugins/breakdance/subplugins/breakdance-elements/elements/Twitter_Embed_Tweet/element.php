...
class TwitterEmbedTweet extends \Breakdance\Elements\Element
{
    ...
    {
        return ['0' =>  ['scripts' => ['%%BREAKDANCE_ELEMENTS_PLUGIN_URL%%dependencies-files/elements-reusable-code/twitter-elements.js'],'builderCondition' => 'return true;',],'1' =>  ['inlineScripts' => ['document.addEventListener("DOMContentLoaded", function(){ new BreakdanceTwitter(\'%%SELECTOR%%\'); });'],'builderCondition' => 'return false;','frontendCondition' => 'return true;',],];
    }
