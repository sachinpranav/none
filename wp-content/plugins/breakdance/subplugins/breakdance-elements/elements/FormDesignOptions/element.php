    ...
    static function designControls()
    {
      ...
      "button",
       ['type' => 'popout']
        ...
        ['type' => 'section', 'layout' => 'inline', 'sectionOptions' => ['type' => 'popout'], 'condition' => ['path' => 'asdasdadsasdasd', 'operand' => 'equals', 'value' => 'hidden_until_we_ship_file_input']],
        false,
        false,
        [],
      ), c(
