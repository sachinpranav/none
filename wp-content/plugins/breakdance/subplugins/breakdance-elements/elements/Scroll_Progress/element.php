...
class ScrollProgress extends \Breakdance\Elements\Element
{
    ...
    {
        return ['0' =>  ['title' => 'Scroll Trigger','scripts' => ['%%BREAKDANCE_ELEMENTS_PLUGIN_URL%%dependencies-files/gsap@3.8.0/ScrollTrigger.min.js'],],'1' =>  ['title' => 'GSAP','scripts' => ['%%BREAKDANCE_ELEMENTS_PLUGIN_URL%%dependencies-files/gsap@3.8.0/gsap.min.js'],],'2' =>  ['scripts' => ['%%BREAKDANCE_ELEMENTS_PLUGIN_URL%%dependencies-files/breakdance-scroll-progress@1/breakdance-scroll-progress.js'],'title' => 'Load Scroll Progress',],'3' =>  ['inlineScripts' => ['new BreakdanceScrollProgress(\'%%SELECTOR%%\', { type: {{ content.tracker.type|json_encode }}, track: {{ content.tracker.track_progress_of|json_encode }}, selector: {{ content.tracker.custom_selector|json_encode }}, direction: {{ design.tracker.direction|json_encode }} } );'],'builderCondition' => 'return false;','title' => 'Load Scroll Progress Frontend',],];
    }
