  ...
  class BreakdanceCircleCounter {
    ...
    arcMove() {
      this.animation = setInterval(() => {
        ...
        this.context.strokeStyle = this.options.style.background_bar;
        this.context.fillStyle = this.options.style.background;
        this.context.lineWidth = this.options.size.background_bar;
        this.context.fill();
        this.context.stroke();
        this.context.beginPath();

        if (this.options.style.bar_style === "gradient") {
          ...
          this.gradient.addColorStop(0, this.options.style.gradient.start);
          this.gradient.addColorStop(1, this.options.style.gradient.end);

          this.context.strokeStyle = this.gradient;
        }

        if (this.options.style.bar_style === "color") {
          this.context.strokeStyle = this.options.style.color.progress_bar;
        }
