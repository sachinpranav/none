...
$comment_form_args = array(
    ...
    'fields' => apply_filters('comment_form_default_fields', array(
        ...
        '<label class="breakdance-form-field__label" for="author">' . __('Name', 'domainreference') . '</label> ' .
        ...
        'email' =>
        '<div class="breakdance-form-field"><label class="breakdance-form-field__label"class="breakdance-form-field__label" for="email">' . __('Email', 'domainreference') . '</label> ' .
        ($req ? '<span class="required">*</span>' : '') .
        ...
        'cookies' => '<div class="breakdance-form-field"><div class="breakdance-form-checkbox"><input id="wp-comment-cookies-consent" name="wp-comment-cookies-consent" type="checkbox" value="yes"' . $consent . ' /><label class="breakdance-form-checkbox__text" for="wp-comment-cookies-consent">Save my name, email, and website in this browser for the next time I comment.</label></div></div>',
...
if (comments_open($postId)) {
    ...
    echo '<div class="breakdance-form-message breakdance-form-message--error comments-form__closed"><p>' . __('Comments closed', 'breakdance') . '</p></div>';
}
