...
'onBeforeDeletingElement' => [['script' => '  (function() {
    ...
    {
        return ['content.content.type', 'content.content.cart', 'design.cart.style', 'design.cart.dropdown_position', 'content.content.after_title_bar', 'content.content.after_footer'];
    }
}
