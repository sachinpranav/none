  ...
  opacity: 1 !important;
    ...
    static public function actions()
    {
        return [
            ...
            'onPropertyChange' => [['script' => 'const postId = window.breakdancePostId;
const breakdancePopupInstance = window.breakdancePopupInstances[postId];
  ...
  breakdancePopupInstance.initAnimations();
  if (breakdancePopupInstance.entranceAnimation) {     
    breakdancePopupInstance.entranceAnimation.play();
  }', 'dependencies' => ['design.popup.animation.entrance'],
            ], ['script' => 'const postId = window.breakdancePostId;
const breakdancePopupInstance = window.breakdancePopupInstances[postId];
if (breakdancePopupInstance) {
  ...
  breakdancePopupInstance.initAnimations();
  if (breakdancePopupInstance.exitAnimation) {
    breakdancePopupInstance.exitAnimation.play().then(() => {
      breakdancePopupInstance.exitAnimation.tween.pause(0);
    });
  }
}', 'dependencies' => ['design.popup.animation.exit'],
            ]]];
    }
