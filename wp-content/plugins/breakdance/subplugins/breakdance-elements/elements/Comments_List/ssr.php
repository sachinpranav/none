    ...
    array(
        ...
        // inline function to allow multiple Comments List elements to be on the same page
            function ($comment, $args, $depth) {
                ...
                $avatarInset = $args['design']['comment']['avatar']['inset'];

                ?>
              <li class="comments-list__item" id="comment-<?php comment_ID();?>" <?php comment_class();?>>
                  ...
                  <div class="comments-list__comment">
                    <header class="comments-list__header">
                      ...
                      <div class="comments-list__author">
                          ...
                          printf(
                              '<h4 itemprop="author" itemscope itemtype="https://schema.org/Person" class="comments-list__author-name">%1$s</span><span itemprop="name" class="screen-reader-text">%2$s</h4>',
                        ...
                        <div class="comments-list__metadata">
                          ...
                          <time itemprop="dateCreated" datetime="<?php comment_time('c');?>" title="<?php echo esc_attr($comment_timestamp); ?>">
                              <?php echo human_time_diff(get_comment_date('U', $comment), current_time('timestamp')) . ' ' . __('ago') ?>
                          </time>
                        </div>
                    ...
                    <div class="comments-list__entry" itemprop="text">
                      <div class="comments-list__text">
                          ...
                          <?php if ('0' === $comment->comment_approved): ?>
                            <p class="comments-list__awaiting-moderation u-text-gray"><?php _e('Your comment is awaiting moderation.', 'breakdance');?></p>
                          <?php endif;?>
                      </div>
                    </div>
                    ...
                    <ul class="comments-list__metadata comments-list__metadata-list">
                        ...
                        if ($edit_link) {
                            echo '<li>';
                            echo '<a class="comment-edit-link" href="' . esc_url(get_edit_comment_link()) . '">' . __('Edit', 'breakdance') . '</a>';
                            echo '</li>';
                        }
...
if ($comment_pagination) {
  ...
  <nav class="pagination<?php echo $pagination_classes ?>" aria-label="<?php esc_attr_e('Comments', 'breakdance');?>">
