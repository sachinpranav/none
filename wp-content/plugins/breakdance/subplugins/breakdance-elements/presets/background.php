...
\Breakdance\Elements\PresetSections\PresetSectionsController::getInstance()->register(
    ...
    c(
        ...
        "Gradient",
        [],
        ['type' => 'gradient', 'layout' => 'vertical', 'condition' => ['path' => '%%CURRENTPATH%%.type', 'operand' => 'equals', 'value' => 'gradient']],
        false,
        false,
        [],
      ), c(
        ...
        ['type' => 'section', 'sectionOptions' => ['type' => 'accordion', 'preset' => ['slug' => 'EssentialElements\\background']]],
        false,
        false,
        [],
      ),
