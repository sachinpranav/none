(function ($) {
  ...
  function bindModalListeners() {
    ...
    document.querySelector(".bde-woo-quicklook-modal-prev")
      ?.addEventListener("click", goPrev);

    document.querySelector(".bde-woo-quicklook-modal-next")
      ?.addEventListener("click", goNext);

    document.querySelector(".bde-woo-quicklook-modal .single_add_to_cart_button")
  ...
  function mounted() {
    const buttons = document.querySelectorAll(".bde-woo-product-quicklook-button");

    buttons.forEach(b => {
      b.addEventListener("click", onQuicklookButtonClick);
    });
  }
