...
function enqueueQtyAssets()
{
    wp_enqueue_script('breakdance-woo-qty', BREAKDANCE_WOO_URL . 'js/quantity.js', ['breakdance-woo-cart'], false, true);
}
add_action('wp_enqueue_scripts', '\Breakdance\WooCommerce\enqueueQtyAssets');
