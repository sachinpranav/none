 ...
 *
 * @psalm-type SsrNode = array{html: string}&PostAssetsWithoutDependencies
 * @psalm-type SsrNodeWithDependencies = array{html: string}&PostAssets
 *
 * @psalm-type ElementSettings = array{dependsOnGlobalScripts?: boolean, withDependenciesInHtml?: boolean, requiredPlugins?: string[]}
 */
