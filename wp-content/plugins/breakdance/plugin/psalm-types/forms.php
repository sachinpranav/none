 ...
 * }
 *
 * @psalm-type FormFieldType = array{label: string, slug: string, handler: string}
 *
 ...
 * }
 * @psalm-type _FILE = array{name: string, type: string, tmp_name: string, error: string, size: int}
 *
 */
