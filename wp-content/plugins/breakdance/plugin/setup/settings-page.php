            ...
            <tr>
                ...
                <td>
                    <form action="" method="post">
                        ...
                        <button type="submit" class="button" name="mode" value="download_export_file">Download Export File</button>
                    </form>
                    <p class='description'>
            ...
            <tr>
                ...
                <td>
                    ...
                    <form class='breakdance-are-you-sure-form wp-upload-form' enctype="multipart/form-data" action="" method="post">
                        ...
                        <input type="file" accept="application/json" name="breakdanceImportData" />
                        <button type="submit" class="button" name="mode" value="upload_export_file">Upload Export JSON File</button>
                    </form>
                </td>
            </tr>
        </tbody>
