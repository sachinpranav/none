 ...
 * @return array{error?: string, data?: array{templates: TemplateData[], isWooCommerceActive: bool, templatesManagementData: array{conditions: TemplateConditionWithValues[], dynamicFields: DynamicField[], templateTypeCategories: JSTemplateTypeCategory[]}}}
 */
function getTemplatesByPostType($postType)
{
    ...
    return ['data' => [
            ...
            'templatesManagementData' => [
                ...
                'dynamicFields' => get_dynamic_fields_for_builder($postType),
