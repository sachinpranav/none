...
use function Breakdance\DesignLibrary\doesDesignLibraryRelyOnGlobalSettings;
use function Breakdance\DesignLibrary\isDesignLibrayEnabled;
...
function load_document()
{
    ...
    $load = array_merge($load, [
        ...
        'designLibrary' => [
            'customDesignSets' => \Breakdance\DesignLibrary\getDesignSets()
        ],
        'trialData' => \Breakdance\Trial\isTrial() ? [
            'isExpired' => \Breakdance\Trial\isTrialExpired()
        ] : false
    ]);
...
add_action('breakdance_loaded', function () {
    \Breakdance\AJAX\register_handler(
        ...
        '\Breakdance\Data\get_global_settings_for_design_library',
        'none',
        true,
        [
            'remote' => true
 ...
 * @return array|null
 */
function get_global_settings_for_design_library(){
    if (isDesignLibrayEnabled() && doesDesignLibraryRelyOnGlobalSettings()){
