...
/**
 * Mapping of bucket IDs to their subpaths
 * @var array<FSBucket, string>
 */
const BREAKDANCE_FS_BUCKETS = [
    ...
    Consts::BREAKDANCE_FS_BUCKET_TWIG_CACHE => 'twig-auto-generated-cache',
];
