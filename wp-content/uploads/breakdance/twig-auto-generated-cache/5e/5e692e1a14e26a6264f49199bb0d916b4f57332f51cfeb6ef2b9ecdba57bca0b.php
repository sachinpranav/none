...
/* 86e10de55804b9b5325f90e82a8a9e09b814e82c */
class __TwigTemplate_81a160dd904dceae9da042c5bb3e363efb54feb43ea79475fda7b3f6a1f49a30 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        echo "
          ";
        // line 2
        $macros["macros"] = $this->macros["macros"] = $this->loadTemplate("macros.twig", "86e10de55804b9b5325f90e82a8a9e09b814e82c", 2)->unwrap();
        // line 3
        echo "
          ";
        // line 4
...
>
          ...
          <div class=\"breakdance-form-field breakdance-form-field--tel\" >
            ...
            <label class=\"breakdance-form-field__label\" for=\"gawlyg\">
            Phone<span class=\"breakdance-form-field__required\">*</span></span>
        </label>
    
    <input
    class=\"breakdance-form-field__input\"
    id=\"gawlyg\"
    aria-describedby=\"gawlyg\"
    type=\"tel\"
    name=\"fields[gawlyg]\"
    placeholder=\"\"
    value=\"\"
...
>
          ...
          <div class=\"breakdance-form-field breakdance-form-field--select\" >
            ...
            <label class=\"breakdance-form-field__label\" for=\"scydis\">
            Select S</span>
        </label>
...
<footer class=\"breakdance-form-field breakdance-form-footer\">
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["step"]) {
            ...
            echo twig_get_attribute($this->env, $this->source, $context["loop"], "index", [], "any", false, false, false, 151);
            echo "\">
            ";
            // line 152
            echo twig_call_macro($macros["macros"], "macro_atomV1ButtonHtmlManual", [(((twig_get_attribute($this->env, $this->source, $context["step"], "previous_button_text", [], "any", true, true, false, 152) &&  !(null === twig_get_attribute($this->env, $this->source, $context["step"], "previous_button_text", [], "any", false, false, false, 152)))) ? (twig_get_attribute($this->env, $this->source, $context["step"], "previous_button_text", [], "any", false, false, false, 152)) : ("Previous Step")), false, "breakdance-form-button breakdance-form-button__previous-step hidden", ($context["previousStepButtonDesign"] ?? null), "secondary", false, false, "step.next_button_text"], 152, $context, $this->getSourceContext());
            echo "
            ";
            // line 153
            echo twig_call_macro($macros["macros"], "macro_atomV1ButtonHtmlManual", [(((twig_get_attribute($this->env, $this->source, $context["step"], "next_button_text", [], "any", true, true, false, 153) &&  !(null === twig_get_attribute($this->env, $this->source, $context["step"], "next_button_text", [], "any", false, false, false, 153)))) ? (twig_get_attribute($this->env, $this->source, $context["step"], "next_button_text", [], "any", false, false, false, 153)) : ("Next Step")), false, "breakdance-form-button breakdance-form-button__next-step hidden", ($context["nextStepButtonDesign"] ?? null), "primary", false, false, "step.next_button_text"], 153, $context, $this->getSourceContext());
            echo "
        </div>
    ";
            ++$context['loop']['index0'];
        ...
        // line 156
        echo "    ";
        echo twig_call_macro($macros["macros"], "macro_atomV1ButtonHtmlManual", [(($context["submitButtonText"]) ?? ("Submit")), false, "breakdance-form-button breakdance-form-button__submit", ($context["submitButtonDesign"] ?? null), "primary", ($context["submitButtonId"] ?? null), true, "content.form.submit_text"], 156, $context, $this->getSourceContext());
        echo "
  ...
  ";
    ...
    {
        return "86e10de55804b9b5325f90e82a8a9e09b814e82c";
    }
    ...
    {
        return array (  321 => 161,  312 => 156,  295 => 153,  291 => 152,  286 => 151,  269 => 150,  263 => 147,  149 => 35,  144 => 32,  128 => 29,  122 => 27,  120 => 26,  117 => 25,  111 => 23,  105 => 21,  103 => 20,  97 => 18,  80 => 17,  76 => 15,  74 => 14,  70 => 13,  56 => 12,  53 => 11,  51 => 9,  50 => 8,  49 => 6,  47 => 5,  45 => 4,  42 => 3,  40 => 2,  37 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("", "86e10de55804b9b5325f90e82a8a9e09b814e82c", "");
    }
}
